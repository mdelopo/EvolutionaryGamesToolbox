...
\include{Chapters/Quickstart} % Include the Quickstart chapter
\include{Chapters/FitnessDynamics} % Include the Fitness Dynamics chapter
\include{Chapters/ImitationDynamics} % Include the Imitation Dynamics chapter
\include{Chapters/Discussion} % Include the Discussion chapter
